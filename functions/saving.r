...
save_graph1_png <- function(penguins_now_clean,
  ...
  agg_png("C:/Users/abrah/OneDrive/Documents/Biology/Year 3/Year 3 R/Computing Assessments/figures/penguin_graph1.png", 
          width   =  25, 
          height  =  20, 
          units   =  "cm", 
          res     =  600, 
...
save_graph2_png <- function(penguins_now_clean,
                            filename, size, res, scaling){
  agg_png("C:/Users/abrah/OneDrive/Documents/Biology/Year 3/Year 3 R/Computing Assessments/figures/penguin_graph2.png", 
          width   =  25, 
          height  =  20, 
          units   =  "cm", 
          res     =  600, 
